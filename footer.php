    ...
    <a href="https://line.me/R/ti/p/@564totjb" target="_blank" class="hidden md:inline-flex fixed z-[10] bottom-[19.4%] right-0 py-[17px] pl-[21px] pr-[29px] bg-[var(--color-blue-50)] rounded-tl-lg rounded-bl-lg justify-start items-center gap-[14px]">
